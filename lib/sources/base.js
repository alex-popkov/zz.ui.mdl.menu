...
goog.require( 'zz.ui.mdl.menu.controllers.Menu' );
...
zz.ui.mdl.menu.bootstrap = function( ){
	...
	goog.ui.registry.setDecoratorByClassName( zz.ui.mdl.menu.enums.CSS.ROOT_ELEMENT, function( ){
	...
	var item = new zz.ui.mdl.menu.controllers.Menu( 'Added menu item' );
...
goog.global[ 'zz.ui.mdl.menu.bootstrap' ] = zz.ui.mdl.menu.bootstrap;